...
export const metadata: Metadata = buildMetadata({
  title: "Contact",
  description: "Contact SongCraft for product support, partnership discussions, and business onboarding.",
  path: "/contact",
});
...
export default function ContactPage() {
  ...
  return (
    <main className="site-container flex w-full flex-1 flex-col px-4 py-12 sm:px-6 lg:px-8">
      ...
      <h1 className="max-w-3xl text-4xl font-bold text-white">Contact SongCraft</h1>
      ...
      <section className="mt-8 w-full max-w-3xl rounded-2xl border border-white/10 bg-slate-900/60 p-6 text-sm text-slate-300">
        <p><strong className="text-white">Email:</strong> support@songcraft.ai</p>
        <p className="mt-2"><strong className="text-white">Sales:</strong> sales@songcraft.ai</p>
