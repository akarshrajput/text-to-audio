...
export default function TermsPage() {
  return (
    <main className="site-container flex w-full flex-1 flex-col px-4 py-12 sm:px-6 lg:px-8">
      <h1 className="max-w-4xl text-4xl font-bold text-slate-900">Terms of Service</h1>
      <div className="mt-6 max-w-4xl space-y-4 text-sm leading-7 text-slate-600">
        <p>By using Songify, you agree to platform usage rules, account security responsibilities, and lawful use of generated outputs.</p>
