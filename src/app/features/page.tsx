...
export default function FeaturesPage() {
  return (
    <main className="site-container flex w-full flex-1 flex-col px-4 py-12 sm:px-6 lg:px-8">
      <h1 className="text-4xl font-bold text-slate-900">Production-focused features for AI audio generation</h1>
      <p className="mt-3 max-w-3xl text-sm leading-7 text-slate-600">
        Songify combines speech and music generation in one environment, with controls designed for consistent output
        and faster iteration.
      </p>

      <section className="mt-8 grid gap-4 sm:grid-cols-2 lg:grid-cols-3">
        <article className="surface-card">
          <h2 className="text-lg font-semibold text-slate-900">Prompt and mood controls</h2>
